...
async def list_articles(
    ...
    return [
        ArticleOut(
            ...
            tags=a.tags if isinstance(a.tags, list) else (list(a.tags.values()) if isinstance(a.tags, dict) else []),
...
async def get_article(db: AsyncSession, article_id: int) -> ArticleOut:
    ...
    return ArticleOut(
        ...
        tags=article.tags if isinstance(article.tags, list) else (list(article.tags.values()) if isinstance(article.tags, dict) else []),
