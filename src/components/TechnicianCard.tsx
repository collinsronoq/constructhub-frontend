...
const TechnicianCard: React.FC<TechnicianCardProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-transform transform hover:scale-[1.02] flex flex-col justify-between overflow-hidden">
      {/* Top Section - Profile */}
