...
const ProjectDetailsResidentialStep: React.FC<ProjectDetailsResidentialStepProps> = ({
  ...
  return (
    <section className="max-w-3xl mx-auto">
      ...
      <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">
        Provide details about your project. Accurate details help ConstructHub
        create a realistic cost estimate.
      </p>
      ...
      <AccordionSection title="Foundation Details" id="foundation">
        <div>
          <label className="block text-sm font-medium mb-1">Foundation Type</label>
          <select
      ...
      <AccordionSection title="Roofing" id="roofing">
        <div>
          <label className="block text-sm font-medium mb-1">Roofing Type</label>
          <select
      ...
      <AccordionSection title="Perimeter Wall" id="perimeterWall">
        <div className="flex items-center space-x-2">
          <input
            id="perimeterWall"
            type="checkbox"
            checked={localData.perimeterWall || false}
            onChange={(e) => handleChange("perimeterWall", e.target.checked)}
            className="w-4 h-4"
          />
          <label
